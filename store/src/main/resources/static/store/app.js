...
function PatientForm({ patient, onSubmit, onCancel }) {
    ...
    const validateForm = () => {
        ...
        if (!formData.provHealthNumber.trim()) newErrors.provHealthNumber = 'Provincial health number is required';
        if (!formData.streetNumber.trim()) newErrors.streetNumber = 'Street number is required';
    ...
    return (
        <form onSubmit={handleSubmit} className="form">
            ...
            <div className="form-row">
                ...
                <div className="form-group">
                    ...
                    <input
                        ...
                        required
                    />
                    {errors.dateOfBirth && <span className="text-error text-sm">{errors.dateOfBirth}</span>}
                </div>
            </div>
            ...
            <div className="form-row">
                ...
                <div className="form-group">
                    <label className="form-label required">Provincial Health Number</label>
                    <input
                        type="text"
                        className="form-input"
                        ...
                        required
                    />
                    {errors.provHealthNumber && <span className="text-error text-sm">{errors.provHealthNumber}</span>}
                </div>
            </div>
            ...
            <div className="form-row-three">
                ...
                <div className="form-group">
                    ...
                    <input
                        ...
                        required
                    />
                    {errors.streetNumber && <span className="text-error text-sm">{errors.streetNumber}</span>}
                </div>
                <div className="form-group">
                    ...
                    <input
                        ...
                        required
                    />
                    {errors.streetName && <span className="text-error text-sm">{errors.streetName}</span>}
                </div>
            </div>
            ...
            <div className="form-row-three">
                ...
                <div className="form-group">
                    ...
                    {errors.province && <span className="text-error text-sm">{errors.province}</span>}
                </div>
                <div className="form-group">
            ...
            <div className="form-group">
                <div className="form-checkbox">
                    ...
                    />
                    <label htmlFor="smsOptIn" className="form-label">SMS Opt-in Preference</label>
                </div>
            </div>
    ...
    return (
        <div className="patient-item">
            <div className="patient-info">
                <h3>{fullName}{preferredName}</h3>
                <p><i className="fas fa-birthday-cake"></i> {patient.dateOfBirth}</p>
                <p><i className="fas fa-phone"></i> {patient.phoneNumber}</p>
                <p><i className="fas fa-map-marker-alt"></i> {address}</p>
                <p><i className="fas fa-id-card"></i> {patient.provHealthNumber}</p>
            </div>
            <div className="patient-actions">
                <button onClick={() => onView(patient)} className="btn btn-secondary btn-sm">
                    <i className="fas fa-eye"></i> View
                </button>
                <button onClick={() => onEdit(patient)} className="btn btn-primary btn-sm">
                    <i className="fas fa-edit"></i> Edit
                </button>
                <button onClick={() => onDelete(patient)} className="btn btn-error btn-sm">
        ...
        <div className="card">
            <div className="card-header">
                <h2 className="card-title">
                    ...
                    {patient.prefName && <span className="text-secondary"> ({patient.prefName})</span>}
                </h2>
            ...
            <div className="form">
                <div className="form-row">
                    <div className="form-group">
                        ...
                        <p className="form-input" style={{backgroundColor: '#f8fafc', border: 'none'}}>{patient.dateOfBirth}</p>
                    </div>
                    <div className="form-group">
                        <label className="form-label">Phone Number</label>
                        <p className="form-input" style={{backgroundColor: '#f8fafc', border: 'none'}}>{patient.phoneNumber}</p>
                    </div>
                </div>

                <div className="form-group">
                    <label className="form-label">Provincial Health Number</label>
                    <p className="form-input" style={{backgroundColor: '#f8fafc', border: 'none'}}>{patient.provHealthNumber}</p>
                </div>

                <div className="form-group">
                    <label className="form-label">Address</label>
                    <p className="form-input" style={{backgroundColor: '#f8fafc', border: 'none'}}>{fullAddress}</p>
                </div>

                <div className="form-row">
                    <div className="form-group">
                        <label className="form-label">Language Preference</label>
                        <p className="form-input" style={{backgroundColor: '#f8fafc', border: 'none'}}>
                ...
                {activeTab === 'delivery' && (
                    <div className="card">
                        <div className="card-header">
                            ...
                            <button onClick={loadDeliverySummary} className="btn btn-secondary">
                        ...
                        {deliverySummary ? (
                            <div className="stats-grid">
                                ...
                                <div className="stat-card">
                                    <div className="stat-value text-success">{deliverySummary.finished}</div>
                                    <div className="stat-label">Completed Deliveries</div>
                                </div>
                                <div className="stat-card">
                                    <div className="stat-value text-warning">{deliverySummary.pending}</div>
